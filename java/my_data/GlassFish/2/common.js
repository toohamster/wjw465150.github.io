...
function showloadinghint(divid, str)
{
	...
	document.write('<div id="' + divid + ' " style="display:none;position:relative;border:1px dotted #DBDDD3; background-color:#FDFFF2; margin:auto;padding:10px" width="90%"  ><img border="0" src="ajax_loading.gif" /> ' + str + '</div>');
}
