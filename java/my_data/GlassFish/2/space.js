...
_ListApp.prototype.Ha=function ()
{
	...
	for(var d=0;d<c.length;d++)
	{
		...
		else 
		{
			if(_old_html)
			{
				a+='<tr><td><a href="http://nt.discuz.net/space/viewspacepost.aspx?postid=630###" onclick="'+this.app_name+'".del("'+d+')"><img src="x.gif" width=16 height=13 border=0></a></td><td nowrap><font size=-1>"'+c[d].C()+'</font></td></tr>'
			}else 
			{
				a+='<a href="http://nt.discuz.net/space/viewspacepost.aspx?postid=630###" onclick="'+this.app_name+".del("+d+')" class="delbox" style="float:left;margin:1px 3px 0px 0px;"></a>'+c[d].C()+
				"<br />"
