...
d.add("58","39","Collection-Take and Drop Items from a List","my_data/Groovy专辑/Goodness/Collection-Take and Drop Items from a List.htm");
d.add("59","39","Collection-Finding Data in Collections","my_data/Groovy专辑/Goodness/Collection-Finding Data in Collections.htm");
d.add("60","39","Collection-Getting the Indices of a Collection","my_data/Groovy专辑/Goodness/Collection-Getting the Indices of a Collection.htm");
d.add("61","39","Collection-GroupBy with Multiple Closures","my_data/Groovy专辑/Goodness/Collection-GroupBy with Multiple Closures.htm");
d.add("62","39","Collection-Observable Map and List","my_data/Groovy专辑/Goodness/Collection-Observable Map and List.htm");
d.add("63","39","Collection-Pop And Push Items In a List","my_data/Groovy专辑/Goodness/Collection-Pop And Push Items In a List.htm");
d.add("64","39","Collection-Revisited Getting the Sum of Items in a Collection","my_data/Groovy专辑/Goodness/Collection-Revisited Getting the Sum of Items in a Collection.htm");
...
d.add("77","39","IO-Transforming Reader Input to Writer Output","my_data/Groovy专辑/Goodness/Transforming Reader Input to Writer Output.htm");
d.add("78","39","Using Groovy for Git Hooks","my_data/Groovy专辑/Goodness/Using Groovy for Git Hooks.htm");
d.add("79","39","XML-Change XML Structure","my_data/Groovy专辑/Goodness/XML-Change XML Structure.htm");
d.add("80","39","XML-Pretty Print XML","my_data/Groovy专辑/Goodness/XML-Pretty Print XML.htm");
d.add("81","39","IO-Use Connection Parameters to Get Text From URL","my_data/Groovy专辑/Goodness/Use Connection Parameters to Get Text From URL.htm");
d.add("82","0","安装指南","");
d.add("83","82","Ambari","");
...
d.add("88","86","(WJW)Docker私有Registry_V1在CentOS6_X下安装指南","my_data/安装指南/Docker/(WJW)Docker私有Registry_V1在CentOS6_X下安装指南.md.html");
d.add("89","86","(WJW)构建企业级Docker_Registry_V2","my_data/安装指南/Docker/(WJW)构建企业级Docker_Registry_V2.md.html");
d.add("90","82","Hadoop","");
d.add("91","90","(WJW)完全分布式Hadoop集群安装指南","my_data/安装指南/Hadoop/(WJW)完全分布式Hadoop集群安装指南.md.html");
d.add("92","82","HBase","");
d.add("93","92","(WJW)完全分布式HBase集群安装指南","my_data/安装指南/HBase/(WJW)完全分布式HBase集群安装指南.md.html");
d.add("94","82","Java","");
d.add("95","94","JMeter技巧","my_data/安装指南/Java/JMeter技巧.md.html");
d.add("96","82","Linux","");
d.add("97","96","CentOS 6.2 双网卡绑定单个IP地址","my_data/安装指南/Linux/!!!CentOS 6.2 双网卡绑定单个IP地址.md.html");
d.add("98","82","Memcached","");
d.add("99","98","(WJW)安装Memcached","my_data/安装指南/Memcached/(WJW)安装Memcached.md.html");
d.add("100","98","(WJW)Memcached高可用安装笔记","my_data/安装指南/Memcached/(WJW)Memcached高可用安装笔记.md.html");
d.add("101","98","定时检测Memcached进程是否存在,若不存在自动启动它","my_data/安装指南/Memcached/定时检测Memcached进程是否存在,若不存在自动启动它.md.html");
d.add("102","82","Redis","");
d.add("103","102","(WJW)Redis高可用安装笔记","my_data/安装指南/Redis/(WJW)Redis高可用安装笔记.md.html");
d.add("104","82","Tomcat","");
d.add("105","104","(WJW)Resin_to_Tomcat转换手册(JSP静态映射版)","my_data/安装指南/Tomcat/(WJW)Resin_to_Tomcat转换手册(JSP静态映射版).md.html");
d.add("106","104","(WJW)Resin_to_Tomcat转换手册(启动时编译版)","my_data/安装指南/Tomcat/(WJW)Resin_to_Tomcat转换手册(启动时编译版).md.html");
d.add("107","104","Tomcat/(WJW)tomcat7安装文档","my_data/安装指南/Tomcat/(WJW)tomcat7安装文档.md.html");
d.add("108","82","Galera_Cluster_For_MySQL","");
d.add("109","108","Galera_Cluster_For_MySQL集群安装","my_data/安装指南/Galera_Cluster_For_MySQL/Galera_Cluster_For_MySQL集群安装.md.html");
d.add("110","0","参考资料","");
